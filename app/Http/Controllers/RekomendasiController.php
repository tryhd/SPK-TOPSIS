...
class RekomendasiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('rekomendasi.index',compact('pemain','alternatif','kriteria','index','data','namakriteria','nilai_kuadrat','bobot','jenis','dpos','dneg','x','normalisasi','bobotxkriteria','ypos','yneg','dposnormal','dnegnormal','v_akhir','urut','tmp'));
    }
    ...
    public function DetailProses(){
        ...
        return view('rekomendasi.detail',compact('pemain','alternatif','kriteria','index','data','namakriteria','nilai_kuadrat','bobot','jenis','dpos','dneg','x','normalisasi','bobotxkriteria','ypos','yneg','dposnormal','dnegnormal','v_akhir','urut','tmp'));
    }
